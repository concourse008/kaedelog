...
'靴を眺めていました。「ちょうどええのがないなぁ…」',
'マイクを磨いていました。「ぴかぴかにしやなな」',
'掃除機をなでていました。「きょうはしずかやな、おまえ」',
'クモから逃げていました。「ミトちゃーん！なんかおるー！！」',
'ダンスしていました。「わんつーはいっはいっ」',
'エルエルにダンスを指導していました。「はいはいずれてるよ！」',
'猫のご飯を味見していました。「まっず」',
'時計を見ていました。「かえでまだかいなー」',
'ボールで遊んでいました。「かったっせー！」',
...
function end(){
  ...
  function dance(){
    ...
    const paragraph = document.createElement('p');
    const dance = ["ノリの良い曲が流れてきました。「だんちぇのじかんや！」","みんな踊っています。「はちみつだんちぇ！」","ダンスが続いています。「つーきーにっカーエデはー！」","最高に盛り上がっています。「おー、いぇいー！」","フィナーレを盛り上げています。「ありがとー！」"]
